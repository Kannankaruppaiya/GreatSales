 ...
 * truth). Enum values match the Prisma schema. Label maps turn enum values into
...
/** Badge tone for a pay zone (traffic-light semantics). */
export const PAY_ZONE_TONE: Record<PayZone, "neutral" | "success" | "warning" | "error"> = {
  GreenZone: "success",
  YellowZone: "warning",
  RedZone: "error",
  Blacklist: "error",
