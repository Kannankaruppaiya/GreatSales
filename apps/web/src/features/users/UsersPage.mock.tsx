...
export default function UsersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {editUser && (
        // Dead file (kept only for Task 10 to delete) — EditUserModal.tsx was
        // rewired to the real UserRow wire type in Task 3, which this old
        // mock User no longer structurally matches. Cast to keep tsc green;
        // this branch never renders (nothing imports UsersPage.mock.tsx).
        <EditUserModal
          open={!!editUser}
          onClose={() => setEditUser(null)}
          user={editUser as unknown as import("@/features/users/types").UserRow}
        />
      )}
