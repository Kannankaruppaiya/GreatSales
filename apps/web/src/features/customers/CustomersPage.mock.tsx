...
export default function CustomersPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {editCustomer && (
        // Dead file (kept only for Task 10 to delete) — EditCustomerModal.tsx
        // was rewired to the real CustomerRow wire type in Task 4, which this
        // old mock Customer no longer structurally matches. Cast to keep tsc
        // green; this branch never renders (nothing imports
        // CustomersPage.mock.tsx).
        <EditCustomerModal
          open={!!editCustomer}
          onClose={() => setEditCustomer(null)}
          customer={editCustomer as unknown as import("@/features/customers/types").CustomerRow}
        />
      )}
    </div>
  );
