...
> ⚠️ **Deleted 2026-09-04:** the repo-root audit and readiness reports
> (`PAGE-ANALYSIS-AUDIT-REPORT.md`, `POC_V6_ORIGINAL_DATA_AND_AUDIT_REPORT.md`,
> `STAGING-READINESS-REPORT.md`, `PRODUCTION-READINESS.md`, `ENGINEERING-CHECKLIST.md`) claimed
> parity the code never had, and this file plus `checklists/` already own every item they listed.
> Do not recreate them: a generated audit is not evidence. `FRONTEND-PRODUCTION-READINESS-QUESTIONNAIRE.md`
> and `DB-SCHEMA-CHECKLIST.md` survive as question banks only — never tick a box on their authority.
...
| [G Security](checklists/07-SECURITY.md) | 43 | 1 | 1 | 0 | 41 |
...
| ~~Real customer records ship in `apps/web/dist`~~ — **fixed & verified 2026-08-25**: mock modules deleted, synthetic fixtures, CI guard | `apps/web/src/data/` | [G.3.9](checklists/07-SECURITY.md) / [D.1.6](checklists/04-FRONTEND-WEB.md) |
